...
describe "Multiverse Travels Booker API" do
  describe "get_travel_stops func" do
    it "return a list of travel stops when params is not passed" do
    ...
    it "return a list of travels optimized when param is true" do
    ...
    it "return a list of travels optimized and expand when params are true" do
